      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center px-6 py-12">
        <div className="w-full max-w-[420px] space-y-9 text-center">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs uppercase tracking-[0.45em] text-white/65">Unlock Yourself</p>
          </div>
          ...
          <div className="space-y-3 text-center text-sm text-white/70">
            <Link href="/signup" className="block text-xs uppercase tracking-[0.35em] text-white hover:text-white/80">
