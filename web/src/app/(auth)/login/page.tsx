    ...
    <div className="relative min-h-screen overflow-hidden bg-black text-white">
      ...
      <div className="relative z-10 flex min-h-screen flex-col">
        <header className="flex flex-col items-center gap-3 px-6 pt-10 text-center">
          ...
          <p className="text-[0.55rem] uppercase tracking-[0.75em] text-[#73FFD1]/80">
        ...
        <main className="flex flex-1 items-center justify-center px-6 pb-12">
          <div className="w-full max-w-xl">
            <div className="text-center">
              <p className="text-xs uppercase tracking-[0.7em] text-[#73FFD1]/80">Member Access</p>
              <h1 className="mt-5 text-3xl font-light uppercase tracking-[0.3em] text-white md:text-4xl">
                Sign In
              </h1>
              <p className="mt-3 text-sm text-white/70">
                Precision coaching, optimized recovery, uncompromised execution.
              </p>
            </div>
